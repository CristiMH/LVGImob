...
const HeatingModal = ({ visible, onClose, onSaved, heatingToEdit }) => {
    const isEdit = Boolean(heatingToEdit);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let res;
            if (isEdit) {
                res = await api.patch(`/api/v1/heating-types/${heatingToEdit.id}/`, { type: type });
            } else {
                res = await api.post(`/api/v1/heating-types/`, { type: type });
            }
                    ...
                    {loading ? (
                        ...
                        <>
                            <div className="flex flex-col gap-[5px]">
                                <p className='text-[14px] font-poppins font-[500]'>Tipul de încălzire</p>
