...
const SurfaceModal = ({ visible, onClose, onSaved, surfaceToEdit }) => {
    const isEdit = Boolean(surfaceToEdit);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let res;
            if (isEdit) {
                res = await api.patch(`/api/v1/surface-types/${surfaceToEdit.id}/`, { type: type });
            } else {
                res = await api.post(`/api/v1/surface-types/`, { type: type });
            }
